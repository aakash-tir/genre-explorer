...
## Corpus Check
- 985 files · ~79,694 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 485 nodes · 795 edges · 31 communities (28 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4e4c45bc`
...
### Community 1 - "lod.ts"
Cohesion: 0.11
Nodes (30): App(), ASSOCIATIVE_KINDS, DRAWN_KINDS, drawnEdges(), focusChildren(), isAssociative(), isDrawn(), structuralDescendants() (+22 more)
...
Cohesion: 0.17
Nodes (20): CameraTransform, computeFit(), Fit, screenRadius(), worldToScreen(), assignFamilyHues(), edgeColor(), genreColor() (+12 more)
...
Cohesion: 0.18
Nodes (10): 2026-08-07, Fix: PR #4 merged red — prettier failure masked by a piped exit code, Milestone 3: the map renders, Milestone 4: focus and the panel — the core loop works end to end, Milestone 5: find your way around — the filter panel, Milestone 6: previews, mobile, and the colour fix, Post-merge chores for PR #10, Post-merge chores for PR #3: knowledge graph refresh + first architecture diagram (+2 more)

### Community 30 - "layout.ts"
Cohesion: 0.12
Nodes (23): buildGraph(), BuiltGraph, slugify(), UnplacedNode, GenreRef, dedupe(), fetchHierarchy(), MbidEdge (+15 more)

## Knowledge Gaps
- **202 isolated node(s):** `singleQuote`, `semi`, `printWidth`, `trailingComma`, `name` (+197 more)
...
- **Why does `GenreNode` connect `App.tsx` to `lod.ts`, `colors.ts`, `layout.ts`?**
