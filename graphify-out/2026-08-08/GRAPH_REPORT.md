...
## Corpus Check
- 989 files · ~103,564 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 506 nodes · 830 edges · 33 communities (29 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d3369c46`
...
### Community 1 - "lod.ts"
Cohesion: 0.17
Nodes (19): ASSOCIATIVE_KINDS, DRAWN_KINDS, drawnEdges(), focusChildren(), isAssociative(), isDrawn(), structuralDescendants(), structuralParent() (+11 more)
...
Cohesion: 0.13
Nodes (27): CameraTransform, computeFit(), Fit, screenRadius(), worldToScreen(), assignFamilyHues(), edgeColor(), genreColor() (+19 more)
...
Cohesion: 0.10
Nodes (39): emitGraph(), ArtistSearch, CandidateArtist, CandidateRecording, escapeLucene(), fetchEntities(), GenreCandidates, RecordingSearch (+31 more)
...
Cohesion: 0.08
Nodes (38): emitDetail(), App(), FilterPanel(), FilterPanelProps, searchGenres(), GraphCanvasProps, createDetailCache(), DatasetError (+30 more)

## Knowledge Gaps
- **212 isolated node(s):** `singleQuote`, `semi`, `printWidth`, `trailingComma`, `name` (+207 more)
...
- **Why does `GraphCanvas()` connect `colors.ts` to `App.tsx`, `lod.ts`, `index.ts`?**
